...
const T = {
  empty: { ko: '첫 댓글을 남겨보세요.', en: 'Be the first to comment.', es: 'Sé el primero en comentar.' },
  locked: { ko: '댓글 {n}개 — 카카오 로그인 후 볼 수 있어요.', en: '{n} comments — log in with Kakao to read them.', es: '{n} comentarios: entra con Kakao para leerlos.' },
  placeholder: { ko: '댓글 남기기', en: 'Write a comment', es: 'Escribe un comentario' },
  replyPlaceholder: { ko: '{name}님에게 답글', en: 'Reply to {name}', es: 'Responder a {name}' },
  submit: { ko: '등록', en: 'Post', es: 'Publicar' },
  reply: { ko: '답글', en: 'Reply', es: 'Responder' },
  cancel: { ko: '취소', en: 'Cancel', es: 'Cancelar' },
  del: { ko: '삭제', en: 'Delete', es: 'Borrar' },
  delConfirm: { ko: '댓글을 삭제할까요?', en: 'Delete this comment?', es: '¿Borrar este comentario?' },
  loginToComment: { ko: '카카오 로그인 후 댓글을 남길 수 있어요.', en: 'Log in with Kakao to comment.', es: 'Entra con Kakao para comentar.' },
  likeA11y: { ko: '좋아요', en: 'Like', es: 'Me gusta' },
  anonName: { ko: '익명', en: 'Anonymous', es: 'Anónimo' },
  ...
  hoursAgo: { ko: '{n}시간', en: '{n}h', es: '{n} h' },
  daysAgo: { ko: '{n}일', en: '{n}d', es: '{n} d' },
};
