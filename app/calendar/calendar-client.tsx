...
const T = {
  title: { ko: '캘린더', en: 'Calendar', es: 'Calendario' },
  subtitle: {
    ko: '모든 카테고리의 모임을 날짜별로 봐요. 날짜를 누르면 그날 모임이 아래에 나와요.',
    en: 'Every meetup by date. Tap a day to see what’s on.',
    es: 'Todas las quedadas por fecha. Toca un día para ver qué hay.',
  },
  subtitleWeek: {
    ko: '한 주 모임을 한눈에 봐요. 날짜를 누르면 그날로 넘어가요.',
    en: 'The whole week at a glance. Tap a day to jump to it.',
    es: 'La semana entera de un vistazo. Toca un día para ir a él.',
  },
  monthView: { ko: '월', en: 'Month', es: 'Mes' },
  weekView: { ko: '주', en: 'Week', es: 'Semana' },
  failed: { ko: '달력을 불러오지 못했어요.', en: 'Couldn’t load the calendar.', es: 'No se pudo cargar el calendario.' },
  prev: { ko: '이전', en: 'Previous', es: 'Anterior' },
  next: { ko: '다음', en: 'Next', es: 'Siguiente' },
  today: { ko: '오늘', en: 'Today', es: 'Hoy' },
  monthLabel: { ko: '{y}년 {m}월', en: '{mon} {y}', es: '{mon} {y}' },
  weekLabel: { ko: '{from} – {to}', en: '{from} – {to}', es: '{from} – {to}' },
  emptyMonth: { ko: '이 달에는 아직 모임이 없어요.', en: 'No meetups this month yet.', es: 'Aún no hay quedadas este mes.' },
  emptyWeek: { ko: '이 주에는 아직 모임이 없어요.', en: 'No meetups this week yet.', es: 'Aún no hay quedadas esta semana.' },
  emptyDay: { ko: '이 날에는 모임이 없어요.', en: 'Nothing on this day.', es: 'Nada este día.' },
  monthCount: { ko: '이 달 모임 {n}개', en: '{n} meetups this month', es: '{n} quedadas este mes' },
  weekCount: { ko: '이 주 모임 {n}개', en: '{n} meetups this week', es: '{n} quedadas esta semana' },
  people: { ko: '{n}명', en: '{n} joined', es: '{n} apuntados' },
  peopleCap: { ko: '{n}/{cap}명', en: '{n}/{cap}', es: '{n}/{cap}' },
  joined: { ko: '참가 중', en: 'Joined', es: 'Apuntado' },
  privateTag: { ko: '비공개', en: 'Private', es: 'Privada' },
  past: { ko: '지난 모임', en: 'Ended', es: 'Terminada' },
};
