...
const STATUS_LABEL: Record<CategoryRequest['status'], Msg> = {
  pending: { ko: '검토 중', en: 'In review', es: 'En revisión' },
  approved: { ko: '승인됨', en: 'Approved', es: 'Aprobada' },
  rejected: { ko: '반려됨', en: 'Declined', es: 'Rechazada' },
};

const T = {
  loading: { ko: '불러오는 중…', en: 'Loading…', es: 'Cargando…' },
  title: { ko: '카테고리 제안', en: 'Suggest a category', es: 'Proponer una categoría' },
  loginPrompt: {
  ...
  intro: {
    ...
    es: '¿Falta alguna afición? Elige nombre, color y subtítulo: lo revisamos y la añadimos.',
  },
  name: { ko: '이름', en: 'Name', es: 'Nombre' },
  namePh: { ko: '예: 등산', en: 'e.g. Hiking', es: 'p. ej. Senderismo' },
  subtitle: { ko: '부제목', en: 'Subtitle', es: 'Subtítulo' },
  subtitlePh: { ko: '예: 같이 오를 사람 모집', en: 'e.g. Find people to hike with', es: 'p. ej. Encuentra con quién caminar' },
  color: { ko: '색상', en: 'Colour', es: 'Color' },
  customColor: { ko: '직접 고르기', en: 'Custom', es: 'Personalizado' },
  preview: { ko: '미리보기', en: 'Preview', es: 'Vista previa' },
  previewName: { ko: '새 카테고리', en: 'New category', es: 'Categoría nueva' },
  namePlaceholderCard: { ko: '이름', en: 'Name', es: 'Nombre' },
  descPlaceholderCard: { ko: '부제목이 여기에 보여요', en: 'Your subtitle shows here', es: 'Tu subtítulo se verá aquí' },
  feature: { ko: '원하는 기능 (선택)', en: 'Feature request (optional)', es: 'Función que te gustaría (opcional)' },
  featureDesc: {
    ...
    es: 'Aparte del subtítulo: cuéntanos qué debería poder hacer esta categoría. Noche de cine, por ejemplo, trae nota, dirección y reparto al buscar un título.',
  },
  featurePh: {
    ko: '예: 등산 코스를 검색하면 거리와 고도를 가져왔으면 좋겠어요',
    en: 'e.g. searching a trail should pull in distance and elevation',
    es: 'p. ej. al buscar una ruta que traiga distancia y desnivel',
  },
  submit: { ko: '제안 보내기 →', en: 'Send suggestion →', es: 'Enviar propuesta →' },
  submitting: { ko: '보내는 중…', en: 'Sending…', es: 'Enviando…' },
  submitFailed: { ko: '제출 실패', en: 'Couldn’t submit', es: 'No se pudo enviar' },
  submitted: {
    ko: '제안을 보냈어요! 검토 후 알림으로 알려드릴게요.',
    en: 'Suggestion sent — we’ll let you know once it’s reviewed.',
    es: 'Propuesta enviada: te avisamos cuando la revisemos.',
  },
  mine: { ko: '내가 보낸 제안', en: 'Your suggestions', es: 'Tus propuestas' },
  mineEmpty: { ko: '아직 보낸 제안이 없어요.', en: 'No suggestions yet.', es: 'Aún no has propuesto ninguna.' },
  featureLabel: { ko: '원하는 기능: {text}', en: 'Feature request: {text}', es: 'Función pedida: {text}' },
