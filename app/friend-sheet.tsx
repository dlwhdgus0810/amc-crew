...
const T = {
  ...
  // 참가자를 눌렀을 때
  addFriend: { ko: '친구 추가', en: 'Add friend', es: 'Añadir amigo' },
  rosterTitle: { ko: '지금 명단', en: 'In this meetup', es: 'En esta quedada' },
  adminTitle: { ko: '모임 명단 고치기', en: 'Edit the roster', es: 'Editar la lista' },
  addSection: { ko: '넣을 사람', en: 'Add someone', es: 'Añadir a alguien' },
  drop: { ko: '빼기', en: 'Remove', es: 'Quitar' },
  dropping: { ko: '빼는 중…', en: 'Removing…', es: 'Quitando…' },
  dropAsk: { ko: '{name}님을 이 모임 명단에서 뺄까요?', en: 'Remove {name} from this meetup?', es: '¿Quitar a {name} de esta quedada?' },
  dropDone: { ko: '{name}님을 뺐어요.', en: 'Removed {name}.', es: '{name} fuera de la lista.' },
  adminHint: {
    ko: '관리자라 친구가 아닌 사람도 넣고 뺄 수 있어요. 지난 모임도요.',
    en: 'As an admin you can add or remove anyone, including on past meetups.',
    es: 'Como administrador puedes añadir o quitar a cualquiera, también en quedadas pasadas.',
  },
  hostHint: {
    ...
    es: 'Esta quedada ya ocurrió: ajusta quién vino de verdad. No se avisa a nadie.',
  },
  sending: { ko: '보내는 중…', en: 'Sending…', es: 'Enviando…' },
  sent: { ko: '친구 요청을 보냈어요.', en: 'Friend request sent.', es: 'Solicitud enviada.' },
  waiting: { ko: '친구 요청을 보내 둔 사이예요. 상대가 수락하면 친구가 돼요.', en: 'Your request is waiting for them to accept.', es: 'Tu solicitud espera a que la acepten.' },
  cancel: { ko: '요청 취소', en: 'Cancel request', es: 'Cancelar solicitud' },
  incoming: { ko: '이분이 먼저 친구 요청을 보냈어요.', en: 'They sent you a friend request.', es: 'Te ha enviado una solicitud.' },
  accept: { ko: '수락', en: 'Accept', es: 'Aceptar' },
  decline: { ko: '거절', en: 'Decline', es: 'Rechazar' },
  already: { ko: '이미 친구예요.', en: 'You’re already friends.', es: 'Ya sois amigos.' },
  unfriend: { ko: '친구 끊기', en: 'Remove friend', es: 'Quitar de amigos' },
  unfriendAsk: { ko: '{name}님과 친구를 끊을까요?', en: 'Remove {name} from your friends?', es: '¿Quitar a {name} de tus amigos?' },
  me: { ko: '나예요.', en: 'That’s you.', es: 'Ese eres tú.' },
  needLogin: { ko: '카카오 로그인 후 친구를 추가할 수 있어요.', en: 'Log in with Kakao to add friends.', es: 'Entra con Kakao para añadir amigos.' },

  // ＋친구
  addTitle: { ko: '친구를 모임에 넣기', en: 'Add a friend', es: 'Añadir un amigo' },
  addHint: {
    ko: '누르면 바로 참가자로 들어가요. 본인이 나가기를 누르면 빠져요.',
    en: 'They join right away — they can leave on their own.',
    es: 'Entra al momento, y podrá salir por su cuenta.',
  },
  addNone: { ko: '이 모임에 넣을 친구가 없어요.', en: 'No friends left to add to this meetup.', es: 'No queda ningún amigo por añadir a esta quedada.' },
  put: { ko: '넣기', en: 'Add', es: 'Añadir' },
  putting: { ko: '넣는 중…', en: 'Adding…', es: 'Añadiendo…' },
  putAsk: { ko: '{name}님을 이 모임에 넣을까요?', en: 'Add {name} to this meetup?', es: '¿Añadir a {name} a esta quedada?' },
  putDone: { ko: '{name}님을 넣었어요.', en: '{name} is in.', es: '{name} ya está dentro.' },
